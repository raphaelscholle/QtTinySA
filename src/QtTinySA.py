...
Development took place on Kubuntu 24.04LTS with Python 3.13 and PySide6 using Spyder.
...
def testComPort():
    index = settings.ui.deviceBox.currentIndex()
...
def connectPassive():
    ...
    settings.ui.deviceBox.activated.connect(testComPort)
